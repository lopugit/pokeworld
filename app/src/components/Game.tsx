...
export class Game extends Component<Record<string, never>, GameComponentState> {
  ...
  private interact = () => {
    ...
    if (interaction.type === "item" && tile) {
      ...
      const item = fieldItemFor(tile.mapX, tile.mapY);
            ...
            >
              <div className="flex flex-row justify-center w-full board-screen relative">
                ...
                <div className="game-ui-layer">
                  ...
                  {ui.panel === "party" ? (
                    <PartyPanel trainer={trainer} onClose={() => this.setUi({ panel: null, menuOpen: true })} />
                  ) : null}
                  {ui.panel === "bag" ? (
                    <BagPanel trainer={trainer} onClose={() => this.setUi({ panel: null, menuOpen: true })} />
                  ) : null}
                  {ui.panel === "badges" ? (
                    <BadgesPanel trainer={trainer} onClose={() => this.setUi({ panel: null, menuOpen: true })} />
                  ) : null}
                  {ui.panel === "pc" ? (
                    <PcPanel trainer={trainer} onClose={() => this.setUi({ panel: null, menuOpen: true })} />
                  ) : null}
                  {ui.dialog ? (
                    <DialogBox
              ...
              <div className="w-full pt-10 md:pt-14 pb-12">
                <div className="controls flex flex-row">
                  ...
                  <div className="ml-auto a-b mr-4 md:mr-12">
                    <button type="button" className="b" onClick={this.pressB}>B</button>
                    <button type="button" className="a" onClick={this.pressA}>A</button>
                  </div>
                </div>
                ...
                <div className="start-select">
                  ...
                  <button type="button" className="start" onClick={this.toggleMenu}>START</button>
                </div>
              </div>
              <div
