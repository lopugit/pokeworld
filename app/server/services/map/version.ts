...
// 2.6.0002: one structure per detected google-maps building, sprite family
// scaled to the footprint — an all-house ladder composed from the red house's
// own cells (wide/grand/manor) with the Pokémon Centre at the mid tier.
const TERRAIN_REVISION = "2.6.0002";
