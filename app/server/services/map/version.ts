...
// 2.6.0003: one structure per detected google-maps building, sprite family
// scaled to the footprint — houses composed from the red house's own cells
// (wide/grand/manor) with the 4x4 Pokémon Center/PokéMart at the mid tier.
const TERRAIN_REVISION = "2.6.0003";
