...
- `Dense Emerald-Style World Desktop UI Screenshot` --conceptually_related_to--> `Deterministic Emerald World Grammar`  [INFERRED]
  docs/qa/dense-world-desktop.png → app/README.md
- `Dense Emerald-Style World Mobile UI Screenshot` --conceptually_related_to--> `Deterministic Emerald World Grammar`  [INFERRED]
  docs/qa/dense-world-mobile.png → app/README.md
- `Trainer Party Desktop UI Screenshot` --references--> `Trainer Party, Items, Badges, and PC Systems`  [INFERRED]
  docs/qa/trainer-party-desktop.png → app/README.md
- `Trainer PC Mobile UI Screenshot` --references--> `Trainer Party, Items, Badges, and PC Systems`  [INFERRED]
...
- **Unified Full-Stack Runtime** — app_readme_react_19, app_readme_react_router, app_readme_vite_8, app_readme_nitro_3, app_readme_vercel_workflow [EXTRACTED 1.00]
- **Durable Map Generation Flow** — app_readme_api_routes, app_readme_generate_map_workflow, app_readme_vercel_workflow, app_readme_map_generation, app_readme_mongodb, app_readme_google_static_maps [EXTRACTED 0.98]
- **Procedural World Acceptance Evidence** — docs_procedural_world_acceptance_required_commands, docs_procedural_world_acceptance_automated_gates, docs_procedural_world_acceptance_native_chrome_gates, docs_procedural_world_acceptance_delivery_gates [EXTRACTED 1.00]
- **Deterministic Map Generation Pipeline** — docs_procedural_world_acceptance_deterministic_world_generation, docs_procedural_world_acceptance_google_colour_semantics, docs_procedural_world_acceptance_emerald_asset_corpus, docs_procedural_world_acceptance_map_pipeline_benchmark, docs_procedural_world_acceptance_google_static_maps_block [EXTRACTED 0.95]
- **Final Delivery Verification** — docs_procedural_world_acceptance_vercel_output_verification, docs_procedural_world_acceptance_native_chrome_qa, docs_procedural_world_acceptance_graphify_outputs, docs_procedural_world_acceptance_ready_pull_request [INFERRED 0.90]
...
## Communities (165 total, 131 thin omitted)
...
Cohesion: 0.07
Nodes (38): blockForCoordinates(), minLatitudeProjected, projectLatitude(), toRadians(), blocksHandler, createLegacyBlocksHandler, generateMapBlock(), isCurrentMapBlock() (+30 more)
...
### Community 3 - "Game"
Cohesion: 0.07
Nodes (45): defaultCoordinates, GameSettings, MapView, MoveAction, PanelId, PlayerState, StoredImage, DialogBox() (+37 more)
...
Cohesion: 0.06
Nodes (44): Pokémon Emerald Exterior Tileset, Pokémon World API Routes, Deterministic Emerald World Grammar, generateMapWorkflow, Google Static Maps Colour Data, Workflow Local World, Map Generation Pipeline, MongoDB Block and Tile Persistence (+36 more)
...
- **Why does `Game` connect `devDependencies` to `types.ts`, `Game`, `verify-vercel-output.mjs`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `TerrainKind` connect `trainer-state.ts` to `Deterministic World Generation`, `pm2.mjs`, `Tile Feature Protocol`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `MapTile` connect `trainer-state.ts` to `Game`, `persisted-state.ts`, `Tile Feature Protocol`?**
