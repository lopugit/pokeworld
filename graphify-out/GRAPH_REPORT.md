...
- [[_COMMUNITY_PcPanel|PcPanel]]
- [[_COMMUNITY_resolveMove|resolveMove]]
- [[_COMMUNITY_Server World Generation|Server World Generation]]
- [[_COMMUNITY_Sign Feature|Sign Feature]]
- [[_COMMUNITY_StartMenu|StartMenu]]
- [[_COMMUNITY_Tile Feature Protocol|Tile Feature Protocol]]
- [[_COMMUNITY_Trainer State Persistence and Migration|Trainer State Persistence and Migration]]
...
- [[_COMMUNITY_Workflow Local World|Workflow Local World]]
...
- [[_COMMUNITY_Graphify Union Merge Workflow|Graphify Union Merge Workflow]]
- [[_COMMUNITY_Multi-Agent Main-Branch Sync Protocol|Multi-Agent Main-Branch Sync Protocol]]
...
- [[_COMMUNITY_Repository Emerald Tileset|Repository Emerald Tileset]]
...
Cohesion: 0.07
Nodes (47): storedBlocksProgress(), blockForCoordinates(), minLatitudeProjected, projectLatitude(), toRadians(), blocksHandler, createLegacyBlocksHandler, generateMapBlock() (+39 more)
...
Cohesion: 0.11
Nodes (19): defaultCoordinates, GameSettings, MapView, MoveAction, PanelId, PlayerState, StoredImage, DialogBox() (+11 more)

### Community 8 - "Pokémon World application"
Cohesion: 0.14
Nodes (23): addItemToBag(), Badge, BagItem, collectFieldItem(), defaultTrainer(), emeraldSprites, hasCollected(), HOENN_BADGES (+15 more)
...
- "hmmm why are we getting this on prod? :O" -> `mongodb`
