# Graph Report - design-map-themes-review-cb860f  (2026-08-12)

## Corpus Check
- 240 files · ~2,554,852 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1876 nodes · 3256 edges · 241 communities (103 shown, 138 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5502652d`
...
- [[_COMMUNITY_runId.get.ts|[runId].get.ts]]
...
- [[_COMMUNITY_PokedexPanel.tsx|PokedexPanel.tsx]]
- [[_COMMUNITY_fetch-character-sprites.mjs|fetch-character-sprites.mjs]]
...
- [[_COMMUNITY_SpriteThumb.tsx|SpriteThumb.tsx]]
...
Cohesion: 0.08
Nodes (50): addNpc(), addPokemon(), boulders(), domeSomewhere(), FLOWERS, freeEntitySpot(), addEntities(), hiddenSomewhere() (+42 more)

### Community 2 - "http.ts"
Cohesion: 0.07
Nodes (38): api, LoginBody, AuthHttpError, clearPokeworldSession(), cookieOptions(), privateJson(), readPokeworldSession(), requireAdminSession() (+30 more)
...
Cohesion: 0.15
Nodes (19): getStoredBlocks(), isMapBlockStorageConfigured(), mapBlockStorageProvider, putStoredBlocks(), isCurrentMapBlock(), blocksCollection(), getStoredBlocks(), isMongoConfigured() (+11 more)
...
Cohesion: 0.12
Nodes (17): dependencies, dotenv, mongodb, nitro, pngjs, react, react-dom, throttled-queue (+9 more)
...
Cohesion: 0.16
Nodes (16): coordinateToken(), decodeThingtimeBlock(), encodeThingtimeBlock(), getThingtimeStoredBlock(), putThingtimeStoredBlock(), sha256(), ThingtimeBlockCrystal, thingtimeBlockId() (+8 more)
...
Cohesion: 0.12
Nodes (20): GROUNDS, RulesTab(), BANNED_GROUND, BANNED_OVERLAYS, BannedTile, expectedPond(), flagsFor(), Formation (+12 more)

### Community 133 - "getSpecies"
Cohesion: 0.12
Nodes (30): generate(), CatalogFilters, catalogTags(), deriveTags(), designCache, designCatalog(), fillBlurb(), generateDesign() (+22 more)
...
### Community 198 - "react"
Cohesion: 0.26
Nodes (10): coordinateKey(), generationOffsetsMissingFromBlocks(), prepareMapGenerationJob(), releasePreparedMapGenerationJob(), reserveGenerationQuota(), coordinatesForInput(), finiteInteger(), parseMapJobInput() (+2 more)
...
### Community 205 - "jiti"
Cohesion: 0.17
Nodes (20): blocksHandler, createLegacyBlocksHandler, generateMapBlock(), generationPermitId(), assertPublicGenerationPermit(), assertPublicWorkflowReservation(), assertRegenerationAllowed(), GenerationControlError (+12 more)
...
### Community 232 - "AnimationSprite.tsx"
Cohesion: 0.20
...
### Community 243 - "generation-quota.ts"
Cohesion: 0.11
Nodes (24): configuredStore(), defaultThingtimeQuotaRequester(), GenerationPermitResult, GenerationQuotaDocument, generationQuotaMongoUri(), GenerationQuotaStatus, getGenerationQuotaStatus(), quotaCollection() (+16 more)
...
- **Why does `Game` connect `Game` to `@types/node`, `Game.tsx`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `devDependencies` to `package.json`, `vite`, `AuthProvider.tsx`, `persisted-state.ts`, `postcss`, `@types/node`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `package.json`, `SpriteThumb.tsx`?**
