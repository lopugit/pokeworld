...
## Summary
- 1482 nodes · 2416 edges · 224 communities (85 shown, 139 thin omitted)
...
- [[_COMMUNITY_normalizeTrainer|normalizeTrainer]]
- [[_COMMUNITY_loadTrainer|loadTrainer]]
- [[_COMMUNITY_node_url|node_url]]
...
- **Procedural World Acceptance Surface** — graphify_out_memory_query_20260719_010429_does_the_completed_pokeworld_procedural_world_acce_cardinal, graphify_out_memory_query_20260719_010429_does_the_completed_pokeworld_procedural_world_acce_procedural_world_properties_test, graphify_out_memory_query_20260719_010429_does_the_completed_pokeworld_procedural_world_acce_normalize_terrain_layout, graphify_out_memory_query_20260719_010429_does_the_completed_pokeworld_procedural_world_acce_complete_acceptance_status [EXTRACTED 0.95]
...
- **Thingtime Client Integration** — graphify_out_memory_query_20260719_121300_where_should_thingtime_sso_session_context__naviga_app, graphify_out_memory_query_20260719_121300_where_should_thingtime_sso_session_context__naviga_nav, graphify_out_memory_query_20260719_121300_where_should_thingtime_sso_session_context__naviga_home_page, graphify_out_memory_query_20260719_121300_where_should_thingtime_sso_session_context__naviga_game_page, graphify_out_memory_query_20260719_121300_where_should_thingtime_sso_session_context__naviga_entry_client [EXTRACTED 0.95]
- **Terrain Sprite Family** — app_map_assets_sprites_grass_grass_sprite, app_map_assets_sprites_sand_1_sand_sprite_1, app_map_assets_sprites_sand_2_sand_sprite_2, app_map_assets_sprites_sand_3_sand_sprite_3, app_map_assets_sprites_sand_4_sand_sprite_4, app_map_assets_sprites_sand_5_sand_sprite_5, app_map_assets_sprites_sand_6_sand_sprite_6, app_map_assets_sprites_sand_7_sand_sprite_7, app_map_assets_sprites_sand_8_sand_sprite_8, app_map_assets_sprites_sand_9_sand_sprite_9 [INFERRED 0.90]
- **Pokemon World Terrain Tile Assets** — app_public_tiles_mountain_9_image, app_public_tiles_pond_center_1_image, app_public_tiles_pond_center_2_image, app_public_tiles_pond_center_3_image, app_public_tiles_pond_center_4_image, app_public_tiles_rock_1_image [INFERRED 0.95]
...
## Communities (224 total, 139 thin omitted)
...
### Community 2 - "http.ts"
Cohesion: 0.08
Nodes (37): LoginBody, AuthHttpError, clearPokeworldSession(), cookieOptions(), privateJson(), readPokeworldSession(), requireAdminSession(), requireSameOrigin() (+29 more)
...
### Community 8 - "Game.tsx"
Cohesion: 0.06
Nodes (55): BoundaryWait, defaultCoordinates, GameComponentState, GameSettings, MapLoadingState, MapView, MoveAction, MoveAnimation (+47 more)
...
Cohesion: 0.09
Nodes (22): devDependencies, autoprefixer, jiti, postcss, sass, tailwindcss, @types/node, @types/react (+14 more)

### Community 11 - "trainer-state.ts"
Cohesion: 0.13
Nodes (14): BADGE_TONES, BadgesPanelProps, BagPanelProps, POCKETS, DialogBoxProps, PanelFrame(), PanelFrameProps, PartyPanelProps (+6 more)

### Community 12 - "pokedex.ts"
Cohesion: 0.11
Nodes (13): BaseStats, byId, byName, entries, expForLevel(), levelForExp(), PokedexEntry, PokemonGender (+5 more)
...
Cohesion: 0.19
Nodes (18): blocksHandler, generateMapBlock(), generationPermitId(), assertPublicGenerationPermit(), assertPublicWorkflowReservation(), assertRegenerationAllowed(), GenerationControlError, isPublicDeployment() (+10 more)
...
Cohesion: 0.10
Nodes (22): addCaughtPokemon(), addItemToBag(), Badge, collectFieldItem(), emeraldSprites, grantExperience(), hasCollected(), HOENN_BADGES (+14 more)

### Community 27 - "ThingtimeGenerationQuotaStore"
Cohesion: 0.06
Nodes (56): A_KEYS, ARROW_KEYS, B_KEYS, BagTab, BattleMenu, BattleScreen(), BattleScreenProps, BREAK_FREE_MESSAGES (+48 more)
...
### Community 197 - "postcss"
Cohesion: 0.14
Nodes (17): fetchSpawnOverrides(), resetSpawnOverride(), saveSpawnOverride(), spawnRulesRequest(), draftNumber(), draftToRule(), fenceLabel(), GenerationQuotaStatus (+9 more)

### Community 198 - "trainer-state.test.ts"
Cohesion: 0.39
Nodes (7): depositPartyMember(), setLeadPartyMember(), toggleBadge(), transition(), useBagItem(), withdrawPartyMember(), fieldItem

### Community 199 - "fetch-pokedex.mjs"
Cohesion: 0.22
Nodes (14): getStoredBlocks(), canUseGoogleStaticMaps(), getBase64ImageSha256(), isFallbackGeneratedBlock(), shouldRegenerateFallbackBlock(), blockCoordinateKey(), blockRevision(), completedBlockSet() (+6 more)

### Community 200 - "battle.test.ts"
Cohesion: 0.29
Nodes (7): BagItem, createPartyMember(), defaultTrainer(), isKnownSprite(), normalizeMember(), spriteForSpecies(), starterMember()

### Community 201 - "extract-terrain-tiles.mjs"
Cohesion: 0.16
...
### Community 202 - "node_path"
Cohesion: 0.36
Nodes (7): isMapBlockStorageConfigured(), mapBlockStorageProvider, putStoredBlocks(), blocksCollection(), getStoredBlocks(), isMongoConfigured(), mongoUri()

### Community 203 - "node_fs"
Cohesion: 0.15
Nodes (16): coordinateKey(), generationOffsetsMissingFromBlocks(), PreparedMapGenerationJob, prepareMapGenerationJob(), reserveGenerationQuota(), MapBlock, MapGenerationWorkflowInput, MapJobInput (+8 more)

### Community 204 - "map-load.ts"
Cohesion: 0.48
Nodes (5): MapOffset, BlockCoordinates, blockCoordinatesForWorldPosition(), blockKeyForWorldPosition(), prioritizeMapPreloadOffsets()

### Community 205 - "applyBattleOutcome"
Cohesion: 0.23
...
### Community 206 - "node_url"
Cohesion: 0.27
Nodes (8): createLegacyBlocksHandler, isCurrentMapBlock(), TerrainKind, MapGenerationResult, MapGenerationStepResult, MapSource, MapTile, users_lopu_things_code_lopugit_pokeworld_app_server_services_map_generate_map_block_version
...
### Community 213 - "ThingtimeGenerationQuotaStore"
Cohesion: 0.40
Nodes (4): Banner(), BannerLink, BannerProps, HomePage()

### Community 214 - "persisted-state.ts"
Cohesion: 0.33
...
### Community 216 - "fetch-character-sprites.mjs"
Cohesion: 0.22
...
Cohesion: 0.29
Nodes (6): root, target, transformedShell, spriteRoot, node_fs, node_path

### Community 220 - "normalizeTrainer"
Cohesion: 0.32
Nodes (8): isRecord(), normalizeBadges(), normalizeCollectedItems(), normalizeDexIds(), normalizeItems(), normalizeMembers(), normalizePokedex(), normalizeTrainer()

### Community 221 - "loadTrainer"
Cohesion: 0.40
Nodes (4): loadTrainer(), readJson(), saveTrainer(), StorageLike

### Community 222 - "node_url"
Cohesion: 0.50
