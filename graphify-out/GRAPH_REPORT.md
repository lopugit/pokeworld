...
- `Pokémon Emerald Exterior Tileset` --conceptually_related_to--> `Generated 16 by 16 Block Tiles`  [INFERRED]
  app/map-assets/tilesets/Game Boy Advance - Pokemon Emerald - Exterior Tileset.png → app/map-assets/db/index.html
...
### Community 17 - "Pokémon World HTML Shell"
Cohesion: 0.67
...
### Community 107 - "Pokémon World application"
Cohesion: 0.15
Nodes (10): API routes, How Workflow works locally, Install and run, Map generation, Pokémon World application, Verification and deployment, Build, Vercel deployments (+2 more)

### Community 108 - "TODO: fallback map regeneration"
Cohesion: 0.33
